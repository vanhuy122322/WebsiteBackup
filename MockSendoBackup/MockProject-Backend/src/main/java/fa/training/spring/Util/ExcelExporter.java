...
public class ExcelExporter {
	...
	public ExcelExporter(List<ProductDTO> productDTOs) {
		super();
...
//	private void writeHeaderLine() {
//		sheet = workbook.createSheet("listTraineeDTO");
//		Row row = sheet.createRow(0);
//		CellStyle style = workbook.createCellStyle();
//		XSSFFont font = workbook.createFont();
//		font.setBold(true);
...
//		createCell(row, 1, "Remarks", style);
//		createCell(row, 2, "Group", style);
//	}
//
//	private void createCell(Row row, int columnCount, Object value, CellStyle style) {
//		sheet.autoSizeColumn(columnCount);
...
//		font.setFontHeight(14);
//		style.setFont(font);
//		for (TraineeDTO traineeDTO : listTraineeDTO) {
//			Row row = sheet.createRow(rowCount++);
//			int columnCount = 0;
//			createCell(row, columnCount++, String.valueOf(traineeDTO.getId()), style);
//			createCell(row, columnCount++, traineeDTO.getRemarks(), style);
//			createCell(row, columnCount++, traineeDTO.getGroup(), style);
//		}
//	}
//
